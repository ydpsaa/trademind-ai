...
export const systemServiceProviders: ProviderCard[] = [
  ...
  },
  {
    ...
    actionLabel: "Test Status",
    setupRequirements: ["Server AI key for real AI reviews", "Optional model setting"],
    ...
    roadmap: ["Additional AI provider option", "Cost controls", "Per-review generation logs"],
  },
  {

...
export const userConnectionProviders: ProviderCard[] = [
  ...
  },
  {
    ...
    name: "OKX",
    category: "Exchange Accounts",
    description: "Future exchange account connection for read-only import and account analytics. Connected accounts will appear in the account selector.",
    purpose: "Trade import and account analytics",
    powers: ["Trade history import", "Account analytics", "Portfolio reconciliation", "Account selector"],
    ...
    roadmap: ["Read-only import", "Account selector entry", "Account analytics", "Execution controls only after explicit future stage"],
  },
  {
    provider: "metatrader",
    name: "MetaTrader",

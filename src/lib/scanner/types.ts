export type MarketSymbol =
  ...
  | "SPXUSDT"
  | "QQQUSDT";
export type MarketType = "Gold" | "Forex" | "Indices" | "Crypto" | "Commodities";
...
export const scannerSymbols: MarketSymbol[] = [
  "XAUUSD",
  "EURUSD",
  "GBPUSD",
  "NAS100",
...
export const scannerMarketTypes: MarketType[] = ["Forex", "Gold", "Indices", "Crypto", "Commodities"];
